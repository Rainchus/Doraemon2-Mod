...
assemble: $(OBJECTS)
	...
	@armips asm/main.asm
	@$(PRINT)$(GREEN)n64crc $(ENDGREEN)$(BLUE)"rom/Doraemon2.mod.z64"$(ENDBLUE)$(ENDCOLOR)$(ENDLINE)
	@./n64crc.exe "rom/Doraemon2.mod.z64"
...
genMain:
	...
	$(file >> $(OUTPUT_FILE),.open "rom/Doraemon2.z64", "rom/Doraemon2.mod.z64", 0 // Open the ROM file)
#	$(file >> $(OUTPUT_FILE),.importobj "assets/TitleScreen.rgba16.png.o")
	...
	$(file >> $(OUTPUT_FILE),.include "asm/bootPatch2.asm")
